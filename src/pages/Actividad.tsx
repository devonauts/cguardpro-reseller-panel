...
const ACCION: Record<string, Clave> = {
  ...
  "company_billing.notice.trial_ending": "actividad.accionAvisoPrueba",
  "company_billing.notice.charge_failed": "actividad.accionAvisoCobroFallido",
  "company_billing.notice.paused": "actividad.accionAvisoPausa",
